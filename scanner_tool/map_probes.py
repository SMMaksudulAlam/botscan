			...
			if(r[j][0]=='c'):
				if(flag == 0):
					if(r[j][3:]==""):
						if(r[j+1][0]=='m'):
							x = r[j+1][2:]
							x = x.replace('31302e302e322e3135', '33352e3230322e3130322e313332') #changing IPs for tricky ones
							fProbe.append(x)
							fPro += r[j+1][2:]
							print("\n\n changed ip \n\n")
					else:
...
workbook = openpyxl.load_workbook('signatures.xlsx')

sheet = workbook['signatures_all'] 
map_probes(sheet)
